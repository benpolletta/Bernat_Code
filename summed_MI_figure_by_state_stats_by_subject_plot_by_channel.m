function summed_MI_figure_by_state_stats_by_subject_plot_by_channel(significance, bands_plotted)
    ...
    for t = 1:no_timesteps
        ...
        for state = 1:no_states
            ...
            for s = 1:no_stats
                ...
                save_as_pdf(gcf,['ALL_summed_MI',norms{n},'_multichannel_', timesteps{t}, band_label, sig_label, '_', states{state}, '_stats_by_subject_plot_by_channel']) %, 'orientation', 'portrait')
