function MI_only_saline_MK801_NVP_figure % (hi_hr, cplot_norm)
...
for n = 1:no_norms
    ...
    for s = 1:no_stats
        ...
        save_as_pdf(gcf,['MI_only',norms{n},'_multichannel_saline_MK801_NVP_', hi_hr, '_hi_', stats{s}, cplot_norm]) %, 'orientation', 'portrait')
