function summed_MI_MK801_NVP_Ro25_figure_plot_by_channel(significance, bands_plotted)
...
for n = 1:no_norms
    ...
    for t = 1:no_timesteps
        ...
        for s = 1:no_stats
            ...
            save_as_pdf(gcf,['ALL_summed_MI',norms{n},'_multichannel_MK801_NVP_Ro25_', timesteps{t}, band_label, sig_label, '_stats_by_subject_plot_by_channel']) %, 'orientation', 'portrait')
