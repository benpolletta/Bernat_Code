function summed_MI_by_state_stats_by_subject_plot_subjects(significance, bands_plotted)
...
for n = 1:no_norms
    ...
    for t = 1:no_timesteps
        ...
        for state = 1:no_states
            ...
            for c = 1:no_channels
                ...
                for d = 2:no_drugs
                    ...
                    for subject = 1:no_subjects
                        ...
                        plot_stats = squeeze(All_BP_stats_by_subject(1:timestep_lengths(t),...
                            subject, bands_plotted, state, 1, 1, n, t, c));
                        ...
                        plot_stats = squeeze(All_BP_stats_by_subject(1:timestep_lengths(t),...
                            subject, bands_plotted, state, 1, d, n, t, c));
            ...
            save_as_pdf(gcf,['ALL_summed_MI',norms{n},'_multichannel_', timesteps{t}, band_label, sig_label, '_', states{state}, '_stats_by_subject_plot_subjects']) %, 'orientation', 'portrait')
