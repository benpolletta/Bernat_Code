function BP_ranksum_by_subject
...
timesteps = {'hrs', '6min'}; no_timesteps = length(timesteps);
...
for n = 1:no_norms
    ...
    for t = 1:no_timesteps
        ...
        suffix = [norms{n}, timesteps{t}, '_', mat_labels{2}];
        ...
        for ch = 1:no_channels
            ...
            for s = 1:no_subjects
                ...
                load([ch_dir, '/', ch_dir, '_', subject, '_BP', suffix, '.mat'])
...
save('BP_ranksum_by_subject.mat', 'All_BP_ranksum')
