function summed_MI_MK801_NVP_Ro25_figure_stats_by_subject(significance, bands_plotted)
        ...
        for s = 1:no_stats
            ...
            for b = 1:no_bands_plotted
                ...
                for d = 2:no_drugs
                    ...
                    ax(b, d - 1) = subplot(no_bands_plotted, no_drugs - 1, (b - 1)*(no_drugs - 1) + d - 1);
                ...
                for d = 2:no_drugs
                    ...
                    subplot(no_bands_plotted, no_drugs - 1, (b - 1)*(no_drugs - 1) + d - 1)
                    
                    plot_test = double(All_BP_test(1:timestep_lengths(t), :, :, bands_plotted(b), d - 1, n, t)); %]; % drug_p_val_index(d) - 1)]; [nan(size(All_BP_test(:, :, bands_plotted(b), d - 1)))... % drug_p_val_index(d) - 1)))...
            ...
            save_as_pdf(gcf,['ALL_summed_MI',norms{n},'_multichannel_MK801_NVP_Ro25_', timesteps{t}, band_label, sig_label, '_stats_by_subject']) %, 'orientation', 'portrait')
