function BP_MK801_NVP_Ro25_figure_stats_by_subject_plot_by_channel(significance, bands_plotted) % (hi_hr, cplot_norm)
        ...
        for s = 1:no_stats
            ...
            for c = 1:no_channels
                ...
                for d = 2:last_drug
                    ...
                    ax(c, d - 1) = subplot(no_channels, no_drugs_plotted, (c - 1)*no_drugs_plotted + d - 1); % (d - 2)*no_bands_plotted + b)
                ...
                for d = 2:last_drug
                    ...
                    subplot(no_channels, no_drugs_plotted, (c - 1)*no_drugs_plotted + d - 1)
