    ...
    for t = 1:no_timesteps
        ...
        for s = 1:no_stats
                ...
                for d = first_drug:last_drug
                    ...
                    if c == 1
                        ...
                        if d - 1 == 1
                            ...
                            legend(my_legend,... band_labels(bands_plotted),...
            ...
            save_as_pdf(gcf,['ALL_BP', norms{n}, '_multichannel',...
                timesteps{t}, make_label('bands', bands_plotted), sig_flag, '_stats_by_subject_plot_by_channel_v2']) %, 'orientation', 'portrait')
