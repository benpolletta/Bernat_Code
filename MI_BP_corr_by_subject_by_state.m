function MI_BP_6min_corr_by_subject_by_state(drug, BP_norm, hr_limits)
...
for p = 1:no_pairs
    ...
    for s = 1:no_subjects
        ...
        MI_struct = load([name, '/', name, '_', measure, '_MI/', name, '_', measure,...
            '_6min_by_state_', subjects{s}, '_cplot_data.mat']);
    ...
    save_as_pdf(gcf, sprintf('%s_%sMI_%sBP%s_%dto%dhrs_by_6min_by_subject',...
        drug, channel_names{pairs(p, :)}, BP_norm, hr_limits))
