function summed_MI_stats_by_subject_plot_subjects(significance, bands_plotted)
...
for n = 1:no_norms
    ...
    for t = 1:no_timesteps
            ...
            for d = 2:no_drugs
                ...
                for subject = 1:no_subjects
                    ...
                    plot_stats = squeeze(All_BP_stats_by_subject(1:timestep_lengths(t),...
                        subject, c, bands_plotted, 1, 1, n, t));
                    ...
                    plot_stats = squeeze(All_BP_stats_by_subject(1:timestep_lengths(t),...
                        subject, c, bands_plotted, 1, d, n, t));
        ...
        save_as_pdf(gcf,['ALL_summed_MI',norms{n},'_multichannel_', timesteps{t}, band_label, sig_label, '_stats_by_subject_plot_subjects']) %, 'orientation', 'portrait')
